...
export class CurrenciesService {
    ...
    async getAllCurrencies() {
        ...
        let allData: {}[] = []
        let currencies = 'bitcoin,ethereum,tether,binancecoin,usdcoin,ripple,cardano,dogecoin,solana,polkadot,shibainu,litecoin,chainlink,stellar,bitcoincash,monero,avalanche,polygon,uniswap,cosmos'
